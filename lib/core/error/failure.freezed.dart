...
return conflict(_that);case CacheFailure() when cache != null:
...
return conflict(_that);case CacheFailure():
...
class ServerFailure implements Failure {
  const ServerFailure({required this.statusCode, required this.code, this.message, this.correlationId});
...
@override
int get hashCode => Object.hash(runtimeType,statusCode,code,message,correlationId);

@override
String toString() {
  return 'Failure.server(statusCode: $statusCode, code: $code, message: $message, correlationId: $correlationId)';
}
...
@useResult
$Res call({
 int statusCode, String code, String? message, String? correlationId
});
...
/// Create a copy of Failure
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? statusCode = null,Object? code = null,Object? message = freezed,Object? correlationId = freezed,}) {
